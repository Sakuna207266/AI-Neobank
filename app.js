...
function drawSpendChart() {
  ...
  const segments = [
    { val: 680, color: '#818CF8' },
    { val: 1850, color: '#F472B6' },
    { val: 310, color: '#38BDF8' },
    { val: 85, color: '#FB923C' },
    { val: 265, color: '#6B6B6B' },
  ];
...
function observeElements() {
  document.querySelectorAll(
    '.solution-card, .problem-item, .budget-card, .testimonial, .feature-row, .credit-feat-card'
  ).forEach(el => {
    el.style.opacity = '0';
